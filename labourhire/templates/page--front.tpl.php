...
<button class="w3-button lh_buttons w3-round-large" style="background:#f2e3cb" id="lh_apply">
 ...
 <div class="row" style="margin-left:0px !important">
	 <p style="float:left;vertical-align:bottom;font-weight:bold;font-size:13px">
		 <a href="https://www.labourhire.qld.gov.au/online-services" style="text-decoration:none;color:#000">Online services</a> |
		 <a href="https://ols.oir.qld.gov.au/applications-register/" style="text-decoration:none;color:#000"> Pending applications</a> |
		 <a href="https://ols.oir.qld.gov.au/licence-register/" style="text-decoration:none;color:#000">Public Register</p></div>
