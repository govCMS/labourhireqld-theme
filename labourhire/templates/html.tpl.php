...
<script src="<?php print $themepath ?>/labourhire/js/owl.carousel.min.js" type="text/javascript"></script>
...
?>
  ...
  <?php if ($add_html5_shim and !$add_respond_js): ?>
    <!--[if lt IE 9]>
    <script src="<?php print $themepath ?>/labourhire/js/html5.js"></script>
    <![endif]-->
  <?php elseif ($add_html5_shim and $add_respond_js): ?>
    <!--[if lt IE 9]>
    <script src="<?php $themepath ?>/labourhire/js/html5-respond.js"></script>
    <![endif]-->
  <?php elseif ($add_respond_js): ?>
    <!--[if lt IE 9]>
    <script src="<?php print $themepath ?>/labourhire/js/respond.js"></script>
    <![endif]-->
  <?php endif; ?>
